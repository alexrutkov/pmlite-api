...
import ru.pmlite.api.security.exceptions.RecaptchaValidException
import java.net.URI
...
class RecaptchaValidator(
    ...
    fun validate(recaptcha: String, secretKey: String): ValidateResult {
        ...
        else throw RecaptchaValidException(result.errorCodes?.joinToString() ?: "Ошибка reCaptcha!")
    }
